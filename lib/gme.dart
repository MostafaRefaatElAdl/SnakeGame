...
import 'package:snk/control_panel.dart';
import 'package:snk/direction.dart';
import 'package:snk/piece.dart';
  ...
  List<Piece> getPieces() {
    ...
    for (var i=0; i<length; ++i){
      ...
      pieces.add(Piece(
        ...
        size: step,
        color: i.isEven? Colors.deepPurple:Colors.deepPurpleAccent,
        isAnimated: false,
      ));
    }
